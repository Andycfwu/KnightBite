...
| --- | --- | --- |
| `success` | `console.info` | A real menu returned, all three meals parsed, and no categorized retrieval/discovery issues were recorded. Normalization counters may still report corrections or missing nutrition. |
